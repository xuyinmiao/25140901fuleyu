...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--llm", choices=("mock", "openai", "deepseek"), default="mock", help="LLM backend")
...
def main(argv: list[str]) -> int:
    ...
    if args.llm == "openai":
        ...
        if not deepseek_api_key:
            print("DEEPSEEK_API_KEY is required for --llm deepseek", file=sys.stderr)
            return 2
        llm_client = OpenAIToolCallingClient(
